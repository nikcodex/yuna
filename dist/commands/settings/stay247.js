...
import { ContainerBuilder, MessageFlags, PermissionFlagsBits, SectionBuilder, SeparatorBuilder, SeparatorSpacingSize, TextDisplayBuilder, ThumbnailBuilder, } from "discord.js";
...
class Stay247Command extends Command {
    ...
    _createStatusContainer(settings, guild, client) {
        ...
        container.addTextDisplayComponents(new TextDisplayBuilder().setContent(`${emoji.get('info')} **24/7 Mode Status**`));
    ...
    async _handleEnable247(messageOrInteraction, current247Settings) {
        ...
        try {
            ...
            return this._createSuccessContainer("24/7 Mode Enabled", `**${emoji.get('folder')} Configuration**\n` +
    ...
    async _handleDisable247(messageOrInteraction, current247Settings) {
        ...
        try {
            ...
            return this._createSuccessContainer("24/7 Mode Disabled", `**${emoji.get('cross')} Status:** Bot will disconnect when queue is empty\n\n` +
    ...
    _createSuccessContainer(title, description) {
        ...
        return buildSuccess(`${description}\n\n*${note}*`, title);
    }
    // @ts-ignore
