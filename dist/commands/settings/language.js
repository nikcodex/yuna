...
class LanguageCommand extends Command {
    ...
    _setupCollector(messageInstance, userId) {
        ...
        collector.on("collect", async (interaction) => {
            try {
                if (interaction.customId === "lang_select") {
                    ...
                    const btnRow = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId("lang_confirm").setLabel("Yes").setStyle(ButtonStyle.Success), new ButtonBuilder().setCustomId("lang_cancel").setLabel("No").setStyle(ButtonStyle.Danger));
