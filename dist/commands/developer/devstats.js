...
class DevStatsCommand extends Command {
    ...
    _createHealthDashboardContainer(client) {
        const container = new ContainerBuilder();
        container.addTextDisplayComponents(new TextDisplayBuilder().setContent(`### 📊 **Bot System & Process Health Dashboard**`));
        ...
        const processSectionContent = `**Process & Memory Metrics**\n` +
        ...
        const section = new SectionBuilder()
            .addTextDisplayComponents(new TextDisplayBuilder().setContent(processSectionContent))
    ...
    _createErrorContainer(msg) {
        const container = new ContainerBuilder();
        container.addTextDisplayComponents(new TextDisplayBuilder().setContent(`### ${emoji.get("cross")} **System Dashboard Error**`));
