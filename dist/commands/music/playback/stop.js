    ...
    async _handleStop(context, pm) {
        ...
        const lastTrackInfo = wasPlaying
            ? {
                ...
                artworkUrl: wasPlaying.info.artworkUrl || config.assets.defaultTrackArtwork,
            }
            : null;
        await pm.stop();
        ...
        if (lastTrackInfo) {
            ...
            const lastTrackContent = `**Last Track**\n\n` +
            ...
            container.addSectionComponents(new SectionBuilder()
                .addTextDisplayComponents(new TextDisplayBuilder().setContent(lastTrackContent))
                .setThumbnailAccessory(new ThumbnailBuilder().setURL(lastTrackInfo.artworkUrl)));
        }
