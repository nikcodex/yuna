...
export function buildContainer(options: any = {}) {
 ...
 */
export function buildError(errorInput: any, title: any = "Error") {
  ...
  return buildContainer({ image: null, thumbnail: null, title, subtitle, content, icon: undefined } as any);
}

/**
 * Signature Boxed Success Card Builder
 */
export function buildSuccess(successInput: any, title: any = "Success") {
 ...
 */
export function buildInfo(infoInput: any, title: any = "Information") {
  const infoIcon = emoji.get('info') || 'ℹ️';
 ...
 */
export function buildWarning(warningInput: any, title: any = "Warning") {
  const infoIcon = emoji.get('info') || 'ℹ️';
 ...
 */
export function buildLoading(loadingInput: any, title: any = "Loading...") {
...
export {
  buildContainer as buildYunaContainer,
  buildError as buildYunaError,
  buildSuccess as buildYunaSuccess
};
